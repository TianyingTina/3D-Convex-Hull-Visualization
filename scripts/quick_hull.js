...
function pre_process_triangle(point_list) {
    ...
    //console.log(m);
    for (var i = 2; i < n; i++) {
        var distance = Math.abs(dotProduct(vectorV(point_list[i], point_list[0]),m)) / m_len;
...
//console.log(pre_process_triangle(points_copy));
